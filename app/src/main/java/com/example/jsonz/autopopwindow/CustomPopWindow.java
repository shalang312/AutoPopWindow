...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    private CustomPopWindowListener popWindowListener;
    ...
    private PopupWindow build() {
        ...
        if (popWindowListener != null) {
            popWindowListener.onCreateView(mContentView);
        }
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder setPopWindowListener(CustomPopWindowListener listener) {
            mCustomPopWindow.popWindowListener = listener;
            return this;
        }
    ...
    public interface CustomPopWindowListener {
